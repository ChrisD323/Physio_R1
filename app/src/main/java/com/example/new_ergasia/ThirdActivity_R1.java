...
public class ThirdActivity_R1 extends AppCompatActivity {
    ...
    private boolean DoesPhysioExist;
...
//        ArrayList<String> ListofPhysios = new ArrayList<>();
                ...
                for (int i=0; i<ListofPhysios.toArray().length; i+=3){ //elegxw an to onoma yparxei hdh
                    if (ListofPhysios.get(i).equals(name_Physio)){
                ...
                if (name_Physio.matches("[a-zA-Z]+") && name_Physio.length()>=3
                    ...
                    if (DoesPhysioExist==false){ //Elegxw an to onoma uparxei hdh sthn vash dedomenwn
                        ...
                        exampleDialog.setText("The name of this Physiotherapy already exist.");
                        exampleDialog.show(getSupportFragmentManager(),"example dialog");
                    }

...
public final class ActivityR1Binding implements ViewBinding {
  ...
  @NonNull
  public final EditText locationPhysio;
  ...
  private ActivityR1Binding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView BottomNav, @NonNull LinearLayout adressR1,
      @NonNull Button eisodosAdminButton, @NonNull ImageView imageView4,
      @NonNull TextView listPhysioR1, @NonNull ImageView locationIcon,
      @NonNull EditText locationPhysio, @NonNull ImageView logo, @NonNull ImageView nameIcon,
      @NonNull EditText namePhysio, @NonNull LinearLayout nameR1, @NonNull EditText passLoginR1,
      @NonNull LinearLayout passwordLoginR1) {
    ...
    this.locationPhysio = locationPhysio;
    this.logo = logo;
  ...
  public static ActivityR1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.location_physio;
      EditText locationPhysio = ViewBindings.findChildViewById(rootView, id);
      if (locationPhysio == null) {
        break missingId;
      }
      ...
      return new ActivityR1Binding((ConstraintLayout) rootView, BottomNav, adressR1,
          eisodosAdminButton, imageView4, listPhysioR1, locationIcon, locationPhysio, logo,
          nameIcon, namePhysio, nameR1, passLoginR1, passwordLoginR1);
    }
